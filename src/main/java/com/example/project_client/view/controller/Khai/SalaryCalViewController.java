...
public class SalaryCalViewController implements Initializable {
    ...
    public void salaryCal() {
        ...
        try {
            ...
            if(idStaffTf.getText() == null || idStaffTf.getText().trim().isEmpty()) {
                totalSalaryLabel.setText(FunctionKhai.convertMoney(totalSalary));
    ...
    private void initStyle(){
        FunctionKhai.validLabel(searchIdLabel);
        FunctionKhai.validLabel(dateStartLabel);
        FunctionKhai.validLabel(dateEndLabel);
        FunctionKhai.validLabel(sumSalaryLabel);
        FunctionKhai.validLabel(totalSalaryLabel);
